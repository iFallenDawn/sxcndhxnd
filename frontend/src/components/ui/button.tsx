...
// Two-register radius system (carried over from v1, now centralized):
// Button is the "primary CTA" register and stays sharp/rounded-none for an
// editorial feel; Badge is the "filter pill" register and stays rounded-full
// (see badge.tsx). Don't reintroduce rounded corners on Button variants.
