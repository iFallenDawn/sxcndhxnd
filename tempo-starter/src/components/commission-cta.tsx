    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 py-32 md:py-48">
        <div className="container mx-auto px-6 md:px-8">
          ...
          >
            <h2 className="font-display text-5xl md:text-7xl font-extralight tracking-tight uppercase mb-6 text-white">
              Custom Commissions
            </h2>
            <p className="text-lg md:text-xl font-light leading-relaxed text-gray-300 mb-12 max-w-2xl mx-auto">
              Transform your vision into reality. Work directly with our artisans to create 
              one-of-a-kind pieces that reflect your unique style and values.
            </p>
