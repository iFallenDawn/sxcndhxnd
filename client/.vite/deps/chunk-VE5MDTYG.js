...
var Outlet = React8.memo(function OutletImpl() {
  ...
  if (matchId === rootRouteId) {
    return (0, import_jsx_runtime6.jsx)(React8.Suspense, { fallback: pendingElement, children: nextMatch });
  }
  return nextMatch;
});
...
function lazyRouteComponent(importer, exportName, ssr) {
  ...
  const lazyComp = function Lazy(props) {
    ...
    if ((ssr == null ? void 0 : ssr()) === false) {
      return (0, import_jsx_runtime7.jsx)(ClientOnly, { fallback: (0, import_jsx_runtime7.jsx)(Outlet, {}), children: React9.createElement(comp, props) });
    }
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VE5MDTYG.js.map
