    ...
    <>
      ...
      <form method="POST" class='flex flex-col'>
        ...
        <label>
          ...
          <select class="border-solid border-2 border-sky-500" name='commissionType'>
        ...
        <label class="flex">
          ...
          <textarea name="pieceVision" placeholder="Type your message" class="border-solid border-2 border-sky-500" />
        </label>
        <label>
        ...
        <label class="flex">
          ...
          <textarea name='extra ' placeholder="Type your message" class="border-solid border-2 border-sky-500" />
        </label>
